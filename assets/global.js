...
if (isRTL) {
  // Corrects the 'ghost' clones specifically for Arabic
  this.totalPages = this.sliderItemsToShow.length - this.slidesPerPage - 2; 
} else {
  // Keeps the original calculation for English
